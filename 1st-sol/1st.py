...
class ARCSolver:
    ...
    def test_time_train(self, ttt_ds):
        ...
        ttt_ds_aug = ttt_ds.remove_test_data().repeat(n=24, seed=42).augment(**self.ttt_aug_opts)
        ttt_ds_as_list = ttt_ds_aug.as_list(len_name='text', **self.fmt_opts)

        print(ttt_ds_as_list[0])
    ...
    def prepare_evaluation(self):
        ...
        """
        base_model = 'Qwen2.5-3B-Instruct-5epoch'
